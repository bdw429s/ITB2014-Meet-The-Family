...
<cfset reportHandler = createObject("component","cachebox.system.cache.report.ReportHandler").init(attributes.cacheFactory,
																								   attributes.baseURL,
																								   attributes.skin,
																								   attributes,
																								   caller)>
...
<style type="text/css"><cfinclude template="/cachebox/system/cache/report/skins/#attributes.skin#/cachebox.css"></style>
<script type="text/javascript"><cfinclude template="/cachebox/system/cache/report/skins/#attributes.skin#/cachebox.js"></script>
