...
----------------------------------------------------------------------->
<cfcomponent hint="I am a cool cool JDBC Store for CacheBox" output="false" implements="wirebox.system.cache.store.IObjectStore">
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="JDBCStore" hint="Constructor">
		...
		<cfscript>
			...
			// Indexer
			instance.indexer = createObject("component","wirebox.system.cache.store.indexers.JDBCMetadataIndexer").init(fields, config, this);
