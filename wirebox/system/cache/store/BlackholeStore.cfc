...
----------------------------------------------------------------------->
<cfcomponent hint="I am the fastest way to cache objects. I am so fast because I dont do anything. I'm really a tool to use when working on caching strategies. When I am in use nothing is cached. It just vanishes." output="false" implements="wirebox.system.cache.store.IObjectStore">

<!------------------------------------------- CONSTRUCTOR ------------------------------------------->

	<!--- init --->
	<cffunction name="init" access="public" output="false" returntype="BlackholeStore" hint="Constructor">
		<cfargument name="cacheProvider" type="any" required="true" hint="The associated cache provider as wirebox.system.cache.ICacheProvider" colddoc:generic="wirebox.system.cache.ICacheProvider"/>
		<cfscript>
			// Store Fields
