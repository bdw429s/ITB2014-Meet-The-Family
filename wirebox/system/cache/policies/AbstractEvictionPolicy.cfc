...
<cfcomponent hint="An abstract CacheBox eviction policy" 
			 output="false" 
			 serializable="false" 
			 implements="wirebox.system.cache.policies.IEvictionPolicy"
			 colddoc:abstract="true">

	<!--- init --->
	<cffunction name="init" output="false" access="public" returntype="AbstractEvictionPolicy" hint="Constructor">
		<cfargument name="cacheProvider" type="any" required="true" hint="The associated cache provider of type: wirebox.system.cache.ICacheProvider" colddoc:generic="wirebox.system.cache.ICacheProvider"/>
		<cfscript>
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="getAssociatedCache" access="public" returntype="any" output="false" hint="Get the Associated Cache Provider of type: wirebox.system.cache.ICacheProvider" colddoc:generic="wirebox.system.cache.ICacheProvider">
