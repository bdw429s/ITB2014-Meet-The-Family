...
<!----------------------------------------- CONSTRUCTOR ------------------------------------->			
	...
	<cffunction name="init" access="public" returntype="ReportHandler" hint="Constructor" output="false" >
		<cfargument name="cacheBox" 	 	type="wirebox.system.cache.CacheFactory" required="true" hint="The cache factory binded to"/>
		...
		<cfscript>
			...
			variables.skinPath  = "/wirebox/system/cache/report/skins/#arguments.skin#";
