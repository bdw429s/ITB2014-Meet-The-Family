...
<cfset reportHandler = createObject("component","wirebox.system.cache.report.ReportHandler").init(attributes.cacheFactory,
																								   attributes.baseURL,
																								   attributes.skin,
																								   attributes,
																								   caller)>
...
<style type="text/css"><cfinclude template="/wirebox/system/cache/report/skins/#attributes.skin#/cachebox.css"></style>
<script type="text/javascript"><cfinclude template="/wirebox/system/cache/report/skins/#attributes.skin#/cachebox.js"></script>
