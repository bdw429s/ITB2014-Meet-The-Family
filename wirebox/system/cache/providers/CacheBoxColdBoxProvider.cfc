...
----------------------------------------------------------------------->
<cfcomponent output="false" extends="wirebox.system.cache.providers.CacheBoxProvider" implements="wirebox.system.cache.IColdboxApplicationCache">
	...
	<cffunction name="init" access="public" output="false" returntype="any" hint="Constructor">
		<cfscript>
			...
			// URL Facade Utility
			instance.eventURLFacade		= CreateObject("component","wirebox.system.cache.util.EventURLFacade").init(this);
...
<!------------------------------------------- ColdBox Application Related Operations ------------------------------------------>
    ...
    <cffunction name="setColdbox" output="false" access="public" returntype="void" hint="Set the coldbox application reference">
    	<cfargument name="coldbox" type="any" required="true" hint="The coldbox application reference as wirebox.system.web.Controller" colddoc:generic="wirebox.system.web.Controller"/>
