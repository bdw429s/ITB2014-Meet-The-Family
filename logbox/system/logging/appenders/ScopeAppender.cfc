...
----------------------------------------------------------------------->
<cfcomponent extends="logbox.system.logging.AbstractAppender" 
			 output="false"
	...
	<cffunction name="init" access="public" returntype="ScopeAppender" hint="Constructor" output="false" >
		...
		<cfscript>
			...
			// Scope storage
			instance.scopeStorage = createObject("component","logbox.system.core.collections.ScopeStorage").init();
			// Scope Checks
