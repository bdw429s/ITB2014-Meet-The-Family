...
----------------------------------------------------------------------->
<cfcomponent extends="logbox.system.logging.appenders.AsyncFileAppender" 
			 output="false"
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" returntype="AsyncRollingFileAppender" hint="Constructor" output="false">
		...
		<cfscript>
			...
			instance.fileRotator = createObject("component","logbox.system.logging.util.FileRotator").init();
